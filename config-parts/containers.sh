...
# Container networks
set container network services prefix '192.168.3.0/24'
...
set container name onepassword-connect network services address '192.168.3.6'
...
set container name onepassword-sync network services address '192.168.3.7'
